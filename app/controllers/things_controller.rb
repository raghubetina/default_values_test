class ThingsController < ApplicationController
  ...
  def thing_params
    params.require(:thing).permit(:integer_column, :string_column, :decimal_column, :datetime_column, :time_column, :date_column, :text_column, :boolean_column, :enum_column)
  end
end
